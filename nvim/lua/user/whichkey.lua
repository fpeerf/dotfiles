...
local m_mappings = {
  ...
  w = {
    name = "Window",
    d = { "<cmd>vertical resize -8<CR>", "Small" },
    i = { "<cmd>vertical resize +8<CR>", "Large" },
  },
...
local mappings = {
  ...
  -- d = {
  --   name = "VimWiki",
  --   t = { "<cmd>VimwikiMakeDiaryNote<cr>", "New" },
  --   i = { "<cmd>VimwikiDiaryGenerateLinks<cr>", "Index" },
  -- },
  ...
  S = {
    ...
    d = { "<cmd>SessionManager load_current_dir_session<cr>", "Load This Dir" },
